...
export declare type ApplicationDefinition = {
...
export declare type ApplicationRenderComponent = (props: ApplicationRenderProps) => JSX.Element;
export declare type ActiveApplication = {
    /** Application ID for reference */
